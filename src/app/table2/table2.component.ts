...
export class Table2Component implements OnInit {
  ...
  columnDefs = [
    ...
    {
      headerName: 'SalesRep Number', field: 'salesrepNumber', width: 158,filter: 'agNumberColumnFilter',
      onCellValueChanged: function (params) {
        console.log(params.oldValue, params.newValue);
        if (params.oldValue != params.newValue) {
          params.cellStyle = { backgroundColor: 'green !important' };
    ...
    , editable: function (params) {
      if (params.data.salesrepNumber == '' || params.data.salesrepNumber == null) {
        return true;
      }
      return false;
    }
  },
{
  headerName: 'Share Segment 1', field: 'shareSegment1', width: 158,
    ...
    , editable: function(params) {
    if (params.data.shareSegment1 == '' || params.data.shareSegment1 == null) {
      return true;
    }
    return false;
  }
